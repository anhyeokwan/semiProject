...
<%@include file="/WEB-INF/views/common/header.jsp" %>
	<div class="page-content">
	    ...
	    <form action="/updateMember.do" method="get">
	        <div class="info-box">
	            <div>전화번호</div>
	            <div><input type="text" class="input-form" placeholder="010-0000-0000 형식으로 입력하세요" value="<%= m.getMemberPhone() %>"></div>
	        </div>
	        <div class="info-box">
	            <div>주소</div>
	            <div class="with-btn"><input type="text" name="addr1" class="input-form" value="<%= m.getMemberAddr() %>"></div>
	        </div>
	        <div>
