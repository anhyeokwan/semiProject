...
<%@include file="/WEB-INF/views/common/header.jsp" %>
    <div class="page-content">
        ...
        <div class="iptHomeAddr">
     	  	<input type="text" name="address" id="address" class="input-form homeAddr" style="display:inline-block" placeholder="배달받을 집주소" readonly>
	        <button class="btn bc1" name ="dd" onclick="searchAddr();">주소검색</button><br>
	        <input type="text" name="detailAddress" id="detailAddress" class="input-form detailAddr"style="display:inline-block" placeholder="상세주소">
        	<button onclick="showMap();" class="btn bc1 movMap">검색한 위치 보기</button>
       	</div>
        
        
            <a href="/quickSelect.do"><button type="button" class="btn1 bc1 PSmnext">다음</button></a>
