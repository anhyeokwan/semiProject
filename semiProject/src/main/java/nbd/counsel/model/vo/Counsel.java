...
public class Counsel {
	...
	public Counsel(String memberId, int counselNo, String counselTitle, String counselSubject, String counselContent,
			int counselCount, String counselDate, int counselAnswer, String filePath, String fileName) {
		super();
