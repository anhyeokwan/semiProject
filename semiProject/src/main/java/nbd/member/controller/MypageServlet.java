...
public class MypageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(memberGrade==1) {
			...
			RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/member/mypageAdmin.jsp");
			...
			RequestDispatcher view = request.getRequestDispatcher("/WEB-INF/views/member/mypagePatient.jsp");
			view.forward(request, response);
		}
	}
