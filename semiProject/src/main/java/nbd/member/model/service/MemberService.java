...
public class MemberService {
	...
	public int updateMemberAddrPw(String memberAddr, String memberPhone, int memberNo) {
		...
		// 합본 후 추가
/*
	public HashMap<String, String> getDoctorPageTotal(int memberNo) {
		// 페이징 처리를 위한 의사의 토탈 경력, 답변, 리뷰 구해오기
		Connection conn = JDBCTemplate.getConnection();
		HashMap<String, Integer> doctorTotalInfo = dao.getDoctorPageTotal(conn, memberNo);
		JDBCTemplate.close(conn);
		return doctorTotalInfo;
	}
*/
	...
	public int insertDoctorReview(String doctorId, String review, int bookNo, int memberNo, int star) {
		// TODO Auto-generated method stub
		Connection conn = JDBCTemplate.getConnection();
