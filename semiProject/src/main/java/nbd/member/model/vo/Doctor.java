...
public class Doctor {
	...
	public Doctor(int doctorNo, String doctorId, String doctorMajor, int doctorAvgStar, String hospitalName,
			String hospitalAddr, String doctorName, String doctorPhoto, String doctorWork, String doctorDate,
			String historyStartYear, String historyEndYear) {
		super();
