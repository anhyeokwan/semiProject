...
public class Book {
	...
	public Book(int bookNo, int memberNo, String bookDate, String bookTime, String bookDoctor, String bookHistory,
			int memberState, String hospitalAddr, String hospitalName, String doctorMajor, int bookPrice,
			String memberPhone, String memberPhoto, String memberAge, String memberName, String docName) {
		super();
		this.bookNo = bookNo;
