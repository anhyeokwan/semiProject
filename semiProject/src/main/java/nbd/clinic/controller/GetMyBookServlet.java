...
public class GetMyBookServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// select book_no, hospital_name, doctor_major, book_date, member_state from book_tbl join doctor_tbl on (doctor_no=BOOK_DOCTOR) where member_no=117 order by book_no desc;
		// 인코딩
